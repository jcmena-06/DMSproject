...
Double dValor1 = Double.parseDouble(request.getParameter("val1LockedTest"));
Double dValor2 = Double.parseDouble(request.getParameter("val2LockedTest"));

//Double vel, tiempo;
Double dResultLockedTest;
//Double n1, n2;


Testing oLockedTest = new Testing();
//dResultSuccessTest=oSuccessTest.metInsertValuesTestPassed();
dResultLockedTest=oLockedTest.metInsertTestLocked(dValor1, dValor2);
%>

<h2> Locked Test </h2>
<br>
<br>
<label>El porcentaje de las pruebas bloqueadas es:</label>
<br>
<br>
 <%= dResultLockedTest  %> % 
