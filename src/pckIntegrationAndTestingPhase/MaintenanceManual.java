...
public class MaintenanceManual extends IntegrationTestingDocument
{
    public MaintenanceManual(){
        System.out.println("Ingresó a la medición del Manual de Mantenimiento");
    }
    
    
    public String measuringMaintenance(String sArchivo){
    	String fileName="";
        ...
        return fileName; 
    }//fin mÃ©todo measuringMaintenance
    ...
    public void measuringMaintenanceManual(){
        measuringMaintenance("archivo");
        measuringStrings();
    }
}
